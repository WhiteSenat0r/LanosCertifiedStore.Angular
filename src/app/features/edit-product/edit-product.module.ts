...
@NgModule({
  declarations: [EditProductComponent, InfoTitleComponent, PhotoUploadSectionComponent, BaseFormSectionComponent, StartStepComponent, FirstRequestStepComponent, AdditionalStepComponent],
  imports: [CommonModule, EditProductRoutingModule, ReactiveFormsModule, IconCarSportComponent, AutocompleteComponent, InputWithSymbolComponent, IconCogComponent, TextareaDefaultComponent, IconDocumentTextComponent],
})
