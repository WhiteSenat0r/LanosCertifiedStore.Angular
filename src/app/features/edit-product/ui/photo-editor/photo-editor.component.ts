import { AfterViewInit, Component, computed, HostListener, input, OnDestroy, OnInit, Optional, Self, signal } from '@angular/core';
import { IconOutlineUploadComponent } from '../../../../shared/icons/icon-outline-upload/icon-outline-upload.component';
import { IconOutlineTrashComponent } from '../../../../shared/icons/icon-outline-trash/icon-outline-trash.component';
